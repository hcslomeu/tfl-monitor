...
| TM-F1 | Phase 1 (research) in progress 2026-05-20 | README polish + demo video + live URL. Research file: `.claude/specs/TM-F1-research.md`. Confirmed drift in `README.md` lines 22–23, 86, 92, 259, 270 and `web/README.md` lines 111, 114. Demo video unscoped — Phase 2 decides hosting/shot list/length. |
